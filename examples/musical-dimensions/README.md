# Musical-dimension worked examples

These examples exercise the Markdown-first model introduced by the musical-dimensions architecture and templates.

They are intentionally small, playable, and reusable. Each example separates:

- reusable musical identity
- session or arrangement realization
- selected technique and expression constraints
- lightweight evidence and review

## Examples

1. [`ii-v-i-through-fourths.md`](ii-v-i-through-fourths.md) — one ii–V–I identity traversed through the circle of fourths
...
Copy or reference only the parts that serve a concrete practice goal. These examples are not mandatory curriculum stages.
