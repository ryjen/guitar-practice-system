# ADR-0002: Open-core and private product boundary
...
Use an open-core dependency model:
...
When classification is uncertain, work starts in the private repository. It may later be promoted to the public core after deliberate generalization, provenance review, security review, and removal of product-specific assumptions.
...
- Allows selected private work to be open-sourced intentionally later
