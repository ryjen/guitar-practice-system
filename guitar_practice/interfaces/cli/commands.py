...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(("backing", "render"), "Render a Score IR backing realization to MIDI", MigrationState.NATIVE, native_handler="backing-render"),
    CommandSpec(("drums", "render"), "Render a Score IR drum realization to MIDI", MigrationState.NATIVE, native_handler="drums-render"),
