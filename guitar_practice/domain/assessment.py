"""Deterministic assessment rules over explicit practice evidence."""
...
from guitar_practice.domain.progression_state import ACTIVE_RANK, STATES, TRANSITIONS

OUTCOMES = frozenset({"pass", "fail", "unknown", "not-applicable", "blocked"})
