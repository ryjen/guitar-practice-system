"""Deterministic repository catalog discovery rules.

This module is the functional core for discovery. It contains no filesystem,
process, network, or presentation concerns.
"""
